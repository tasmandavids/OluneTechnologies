  ...
  return (
    <div className="overflow-hidden rounded-2xl border border-[--hair] bg-surface">
      ...
      {Array.from({ length: rows }, (_, i) => (
        <div key={i} className="flex items-center gap-4 border-b border-[--hair] px-5 py-4 last:border-b-0">
...
export function SkeletonTwoPane() {
  return (
    <div className="grid gap-4 lg:grid-cols-[320px_1fr]">
      <div className="space-y-2 rounded-2xl border border-[--hair] bg-surface p-3">
      ...
      <div className="hidden rounded-2xl border border-[--hair] bg-surface p-6 lg:flex lg:flex-col lg:gap-4">
