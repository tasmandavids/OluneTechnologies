...
export function SidebarLayout({ accent, studioName, headline, tagline, eyebrow }: LayoutHeroProps) {
  return (
    <div style={{ display: "flex", minHeight: 900 }}>
      <div style={{ flex: "0 0 300px", padding: "52px 40px", boxSizing: "border-box", display: "flex", flexDirection: "column", justifyContent: "space-between", background: accent, color: "#fff" }}>
        <div>
          <div style={{ fontSize: 32, letterSpacing: "-0.01em", fontFamily: "var(--font-display)" }}>{studioName}</div>
      ...
      <div style={{ flex: 1, padding: "56px 56px 60px", boxSizing: "border-box" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1.4fr 1fr", gridTemplateRows: "230px 190px", gap: 18, marginTop: 44 }}>
          <div style={{ background: `linear-gradient(150deg, color-mix(in srgb, ${accent} 32%, #e7e3db), color-mix(in srgb, ${accent} 9%, #f4f1ea))` }} />
          <div style={{ background: `linear-gradient(20deg, color-mix(in srgb, ${accent} 20%, #eae6df), color-mix(in srgb, ${accent} 6%, #f6f3ed))` }} />
          <div style={{ background: `linear-gradient(200deg, color-mix(in srgb, ${accent} 14%, #ece8e1), color-mix(in srgb, ${accent} 5%, #f6f3ed))` }} />
          <div style={{ background: `linear-gradient(120deg, color-mix(in srgb, ${accent} 40%, #e4e0d8), color-mix(in srgb, ${accent} 12%, #f2efe8))` }} />
        </div>
      </div>
    </div>
  );
